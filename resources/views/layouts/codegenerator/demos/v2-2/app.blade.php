...
<head>
    ...
    <title>Laravel Code Generator Demo v2.2</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a href="{!! URL::route('laravel-code-generator.demos.v2-2.biography.index') !!}" class="navbar-brand">Laravel Code Generaotr Demo v2.2</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="{!! url('/') !!}">CrestApps</a></li>
            <li><a href="{!! URL::route('laravel-code-generator.docs', ['version' => '2.2']) !!}">View Documentations</a></li>
          </ul>
