...
<section id="features">
	...
	<ul>
		...
		<li>Allows you to save the field in a json file and recreate resources when the business needs changes.</li>
	    ...
	    <li>Easy commands to create fields-file; additionally, add or reduce existing fields-file.</li>
	    ...
	    <li>Create a very clean and reusable code.</li>
	</ul>
</section>
...
<h3><a href="{!! URL::route('laravel-code-generator.demos.v2-1.biography.index') !!}" target="_blank">Live Demo</a></h3>

<p>
A live demo of a site which was generated using laravel code generator v2.1 can be found <a href="{!! URL::route('laravel-code-generator.demos.v2-1.biography.index') !!}" target="_blank">here</a>.
</p>

<p>This demo was generated using the following two commands</p>

<p>
<pre>php artisan fields-file:create Biography --names=name,age,biography,sport,gender,colors,is_retired,photo,range,month
