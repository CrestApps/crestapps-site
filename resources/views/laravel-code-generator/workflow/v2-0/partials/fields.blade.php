    ...
    2
       ...
       <tr>
        ...
        <tr>
            ...
            <td>
                <p>
                    This option will allow you to cast a field to php native type.
                </p>
            </td>
        </tr>
                ...
                <pre class="bg-warning">
{
    ...
    "references-model": "App\\Models\\User" // the namespace of the foreign model.
        ...
        <tr>
            ...
            <td>
                <p>
                    This options allows you to set a fixed value on the store action. For example, <code>Illuminate\Support\Facades\Auth::Id();</code> will set the value to the current user id when the model is first created.
                </p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <p>
                    This options allows you to set a fixed value on the update action. For example, <code>Illuminate\Support\Facades\Auth::Id();</code> will set the value to the current user id when the model is updated.
                </p>
            </td>
        </tr>
