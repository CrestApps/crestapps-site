...
<section id="how-to-create-views-layout">
	...
	<div class="table-responsive">
		...
		<tr>
			...
			<td>
				<p>This option allows you to create a layout without any client-validation</p>
...
<section id="how-to-create-resources">
	...
	<div class="table-responsive">
		...
		<tr>
			<td>--fields-file</td>
			<td>
				<p>File name to import fields from. This option allows you to put all your fields in one json file, and then import it from the command line. This is a powerful feature which makes it easy to reuse the same fields in multiple command now or later. More documentation about this feature can be found in the "<a href="{!! URL::route($routeName, ['version' => $version]) !!}#model-fields-raw">assign model fields from a raw string</a>" section.</p>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<p>Instead of placing the field's validation rules directly in the controller class, this option will extract the rules into a separate form-request class. FormRequest class allows you to do more complex validation, cleans up your controller, and increases your code reusability.</p>
				<div class="alert alert-warning">
					<p>By default, the method <var>authorize()</var> is set to return <em>false</em> for your application's security. This method must be modified to return a <em>true</em> value for the <var>store</var> and <var>update</var> requests to be allowed. Otherwise, the request will be <var>Forbidden</var></p>
				</div>
			</td>
		</tr>
...
<section id="how-to-create-controller">
	...
	<div class="table-responsive">
		...
		<tr>
			<td>--fields-file</td>
			<td>
				<p>File name to import fields from. This option allows you to put all your fields in one json file, and then import it from the command line. This is a powerful feature which makes it easy for you're to reused the same fields in multiple command now or later. More documentation about this feature can be found in the "<a href="{!! URL::route($routeName, ['version' => $version]) !!}#model-fields-raw">assign model fields from a raw string</a>" section.</p>
			</td>
		</tr>
...
<section id="how-to-create-model">
	...
	<div class="table-responsive">
		...
		<tr>
			<td>--fields-file</td>
			<td>
				<p>File name to import fields from. This option allows you to put all your fields in one json file, and then import it from the command line. This is a powerful feature which makes it easy for you to reuse the same fields in multiple command now or later. More documentation about this feature can be found in the "<a href="{!! URL::route($routeName, ['version' => $version]) !!}#model-fields-raw">assign model fields from a raw string</a>" section.</p>
			</td>
		</tr>
...
<section id="how-to-create-views">
	...
	<div class="table-responsive">
		...
		<tr>
			<td>--fields-file</td>
			<td>
				<p>File name to import fields from. This option allows you to put all your fields in one json file, and then import it from the command line. This is a powerful feature which makes it easy for you're to reuse the same fields in multiple command now or later. More documentation about this feature can be found in the "<a href="{!! URL::route($routeName, ['version' => $version]) !!}#model-fields-raw">assign model fields from a raw string</a>" section.</p>
			</td>
		</tr>
	...
	<div class="table-responsive">
		...
		<tr>
			<td colspan="2">
				<dl class="dl-horizontal">
		            <dt>Command</dt>
		            <dd><code>php artisan fields-file:create [file-name]</code></dd>
		            <dt>Example</dt>
		            <dd><code>php artisan fields-file:create commends.json</code></dd>
		        </dl>
			</td>
		</tr>
	...
	<div class="table-responsive">
		...
		<tr>
			<td colspan="2">
				<dl class="dl-horizontal">
		            <dt>Command</dt>
		            <dd><code>php artisan fields-file:append [file-name]</code></dd>
		            <dt>Example</dt>
		            <dd><code>php artisan fields-file:append commends.json</code></dd>
		        </dl>
			</td>
		</tr>
	...
	<div class="table-responsive">
		...
		<tr>
			<td colspan="2">
				<dl class="dl-horizontal">
		            <dt>Command</dt>
		            <dd><code>php artisan fields-file:reduce [file-name]</code></dd>
		            <dt>Example</dt>
		            <dd><code>php artisan fields-file:reduce commends.json</code></dd>
		        </dl>
			</td>
		</tr>
