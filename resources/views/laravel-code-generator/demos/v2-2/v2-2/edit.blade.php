...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('laravel-code-generator.demos.v2-2.biography.update', $biography->id) }}" id="edit_biography_form" name="edit_biography_form" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            @include ('laravel-code-generator.demos.v2-2.v2-2.form', [
                                        'biography' => $biography,
                                      ])
