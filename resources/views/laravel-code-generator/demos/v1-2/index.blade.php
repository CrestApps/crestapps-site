                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <a href="{{ route('laravel-code-generator.demos.v1-2.biography.show', $biography->id ) }}" class="btn btn-success btn-xs" title="View Biography">
                                        <span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span>
                                    </a>
                                    <a href="{{ route('laravel-code-generator.demos.v1-2.biography.edit', $biography->id ) }}" class="btn btn-primary btn-xs" title="Edit Biography">
