...
<div class="form-group {{ $errors->has('is_retired') ? 'has-error' : ''}}">
    <label for="is_retired" class="col-md-2 control-label">Retired?</label>
    <div class="col-md-10">
        <div class="checkbox">
            <label for="is_retired_1">
            	<input id="is_retired_1" class="" name="is_retired" type="checkbox" value="1" {{ old('is_retired', isset($biography) ? $biography->is_retired : '') == '1' ? 'checked' : '' }}>
                Yes
            </label>
        </div>
