...
php artisan create:resources Biography --resource-file=demos\code-generator-v2-2\biographies.json --model-directory=Demos\CodeGenerator\v22 --controller-directory=Demos/CodeGenerator/v22 --force --with-form-request --form-request-directory=Demos\CodeGenerator\v22 --table-name=code_generator_v22_biographies  --routes-prefix=laravel-code-generator/demos/v2-2 --views-directory=v2-2 --models-per-page=15
...
<div class="row">
  ...
  <div class="col-md-8 col-sm-12 large-padding-sections" id="docs-main-column">
      ...
      @include($viewName . '.partials.whats-new')
      @include($viewName . '.partials.how-to')
      @include($viewName . '.partials.fields')
      @include($viewName . '.partials.configurations')
