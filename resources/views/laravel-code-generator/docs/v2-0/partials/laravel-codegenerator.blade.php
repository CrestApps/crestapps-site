...
<section id="features">
	...
	<ul>
	    ...
	    <li>Automatically handles the relations between the models.</li>
	    ...
	    <li>Nicely format any datetime, date or time field.</li>
...
<h3><a href="{!! URL::route('laravel-code-generator.demos.v1-2.biography.index') !!}" target="_blank">Live Demo</a></h3>

<p>
A live demo of a site that was generated using laravel code generator can be found <a href="{!! URL::route('laravel-code-generator.demos.v1-2.biography.index') !!}" target="_blank">here</a>.
</p>
