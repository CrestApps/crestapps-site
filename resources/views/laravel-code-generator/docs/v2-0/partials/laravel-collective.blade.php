...
<section id="using-laravel-collective">
	...
	<p>This package is fully capable of generating views using <a href="https://laravelcollective.com/docs/5.3/html" target="_blank">Laravel-Collective</a> package. In fact, it is shipped with a template based on laravel-collective called "default-collective".</p>
	...
	<pre>php artisan vendor:publish --provider="CrestApps\CodeGenerator\CodeGeneratorServiceProvider" --tag=collective-template</pre>
