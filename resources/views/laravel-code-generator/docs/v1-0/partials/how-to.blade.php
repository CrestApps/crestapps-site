...
<section id="how-to-create-resource">
	...
	<div class="table-responsive">
		...
		<tr>
			<td colspan="2">
				...
				<dl class="dl-horizontal">
		            <dt>Command</dt>
		            <dd><code>php artisan create:resource [model-name]</code></dd>
		            <dt>Example</dt>
		            <dd><code>php artisan create:resource Post --fields-file=post.json</code></dd>
		        </dl>
		...
		<tr>
			...
			<td>
				...
				<p>When this option is used, the database's name is assumes to be the plural-form of the provided "model-name". Of course, the table name can be set to a different value by passing the <code>--table</code> option.</p>
		...
		<tr>
			...
			<td>
				...
				<p>
				This example will generate the following code</p>
...
<section id="how-to-create-field-file">
	...
	<p>You can easily take advantage of this feature by passing <code>--table-exists</code> option to the <code>create:resouce</code> command to automatically generate all the resources from existing database's table.</p>
	</div>
