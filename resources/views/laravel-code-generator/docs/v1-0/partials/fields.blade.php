    ...
    <div class="table-responsive">
        ...
        <tr>
            ...
            <td>
                ...
                <p>To learn more about the valid options please visit <a href="https://laravel.com/docs/5.3/validation#available-validation-rules" title="Laravel documentation" target="_blank">Laravel documentation</a></p>
       ...
       <tr>
            ...
            <td>
                ...
                <p>
                    However, when using <var>--fields-file</var> option to import json, you can define multiple language phrases for each option</p>
<pre>
"options": {
    "": {
