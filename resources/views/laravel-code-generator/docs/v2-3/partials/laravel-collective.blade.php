...
<section id="using-laravel-collective-how-to-generate">
	...
	<blockquote>
		...
		<p>
		<small>Open the config file of the package <mark>/config/codegenerator.php</mark> change the value of the key <code>template</code> to <code>default-collective</code></small>
		</p>
